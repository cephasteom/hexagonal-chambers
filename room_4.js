...
// s0.p.cutoff.set(energy).mtr(400,10000)
// s0.p.res.set(energy).mtr(0.9,0.1)
...
s1.set({in:2,ba:'oriki',snap:z.q,lc:0.75,cut:1,dur:ms(1/16),r:10,dtime:50,dfb:0.85})
...
s3.set({inst:0,fx0:1,fx1:1,level:0.5,dur:ms(2),a:ms(4),cut:3,lag:ms(4),moda:ms(4),strum:ms(1),lc:0.5})
