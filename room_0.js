...
s0.set({in:2,bank:'design',res:0.1})
s0.p.i.random(0,4,1)
s0.p._vol.mul(0.75)
...
s1.set({in:2,bank:'rumble',dur:ms(16),snap:q*16,n:49,i:4,lag:ms(smoothing),a:10,
r:500,fx0:1})
...
s4.set({in:1,bank:'air',dur:ms(16),snap:q*2,i:3,lag:ms(smoothing),loop:1,fx0:1})
...
s5.set({in:1,bank:'gm.static',dur:ms(2),i:3,lag:ms(smoothing),cut:2,fx0:1,fx1:1})
