...
z.p.space.cc(1,10,0)
z.p.fx0level.cc(2,10,0.5)
z.p.fx1level.cc(3,10,0.5)
z.e.set(1)
z.m.set(1)
...
r:500,fx0:1,level:0.25})
s1.px._cutoff.saw(100,1000).$mul.set(z.p.energy).mtr(1,4)
s1.p._res.set(z.p.energy).mtr(0.25,0.1)
s1.px._grainrate.saw(4,12,1)
s1.py._grainsize.saw()
s1.p.begin.saw(0,1,0,1/16)
s1.e.reset().every(q*2)

s4.set({in:1,ba:'air',dur:ms(16),snap:q*2,i:3,lag:ms(smoothing),loop:1,fx0:1})
