...
s0.set({inst:2,bank:'breaks.hp?breaks.archn*16',snap:z.q*loop,cut:[0,1],fx0:1/8,d:ms(1/4),s:0.25,cutr:ms(1/2),r:ms(2),res:0.25,lag:ms(smoothing)})
s0.p.i.random(0,6).step(1)
s0.px.n.set('50 Dmi%6..?*15')
// s0.px._cutoff.saw().add(1).mul($set(energy).mtr(400,5000))
